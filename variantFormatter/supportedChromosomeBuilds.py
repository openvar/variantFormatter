...
"""
Simple dictionary lookup function that takes the VCF chromosome identifier and the genome build
(labelled primary_assembly) and returns the relevant RefSeq chromosomal or ALT or patch accession
and version number
    
Note, hg19 and GRCh37 dictionaries are separated due to the difference in the mitochondrial reference
sequence. Otherwise the two dictionaries are the same.
    
GRCh38 and hg38 are identical, so only the GRCh38 dictionary is stated
"""
...
def to_chr_num_refseq(accession):
    # Available genome builds
    chr_num_convert = {
        "NC_000001": "1",
        "NC_000002": "2",

...
pos_lock, hard_right and hard_left are used to compensate for gapped alignments
"""
...
def report_hgvs2vcf(hgvs_genomic_variant, primary_assembly, reverse_normalize, sf):
...
def hgvs2vcf(hgvs_genomic, primary_assembly, reverse_normalize, sf):
